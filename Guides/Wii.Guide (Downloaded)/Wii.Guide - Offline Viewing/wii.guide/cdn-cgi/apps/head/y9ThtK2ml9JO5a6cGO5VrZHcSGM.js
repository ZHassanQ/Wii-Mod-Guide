;window.CloudflareApps=window.Eager=window.CloudflareApps||window.Eager||{};window.CloudflareApps=window.CloudflareApps||{};CloudflareApps.siteId="cb415ea6f1796d9f990c99b7220bce7d";CloudflareApps.installs=CloudflareApps.installs||{};;(function(){'use strict'
...
return false}}());CloudflareApps.installs["L6IoKKdESdz6"]={appId:"lMxPPXVOqmoE",scope:{}};;CloudflareApps.installs["L6IoKKdESdz6"].options={"account":{"accountId":"LFl4UrnDn4u0","service":"googleanalytics","userId":"102827806199678972703"},"id":"UA-72766480-5","social":false};;CloudflareApps.installs["os3sjw67ceZe"]={appId:"XzVIEqe1R2kW",scope:{}};;CloudflareApps.installs["os3sjw67ceZe"].options={"chrome":48,"edge":25,"firefox":45.8,"ie":9,"safari":9};;if(CloudflareApps.matchPage(CloudflareApps.installs['L6IoKKdESdz6'].URLPatterns)){(function(){var options=CloudflareApps.installs['L6IoKKdESdz6'].options
var id
if(options.account){id=options['web-properties-for-'+options.organization]}else{id=(options.id||'').trim()}
...
gtag('event','share',{method:'twitter',event_action:'tweet',content_id:targetUrl})}})}},false)}}())}(function(){var script = document.createElement('script');script.src = '/cdn-cgi/apps/body/p0BQQ68VsfDGCeh9VEhGUwLjD-I.js';document.head.appendChild(script);})();